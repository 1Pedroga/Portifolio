...
public class Combustivel extends JDialog {
	 ...
	 */
	public Combustivel() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Combustivel.class.getResource("/img/Gasolina (2).png")));
		...
		btnNewButton.setIcon(new ImageIcon(Combustivel.class.getResource("/img/Igual.png")));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				calcular();
			}
		});
		btnNewButton.setBounds(126, 75, 64, 64);
